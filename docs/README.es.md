...
Una utilidad para verificar las estadísticas de su CPU y regular automáticamente las velocidades del reloj para ayudar con el rendimiento o la duración de la batería.

Este programa está diseñado para computadoras portátiles Linux e Intel, aunque en teoría debería funcionar en sistemas AMD y, a veces, también en computadoras de escritorio. 

Si encuentra un problema, consulte [wiki](https://github.com/JakeRoggenbuck/auto-clock-speed/wiki) para ver si hay una solución. 
